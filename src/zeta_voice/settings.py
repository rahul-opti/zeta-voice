...
from zeta_voice.paths import SLOTS_WITH_RESPONSES_PATH
...
class EngineSettings(BaseSettings):
    ...
    DB_PATH: str = "data/zeta_voice.db"
...
class TelephonySettings(BaseSettings):
    ...
    def BASE_URL(self) -> str:  # noqa
        """Returns the public base URL of the service."""
...
class StorageSettings(BaseSettings):
    ...
    AWS_S3_BUCKET_NAME_OAI: str = "static-recordings-oai"
    AWS_S3_BUCKET_NAME_11LABS: str = "static-recordings-11labs"
    # Optional: override endpoint for LocalStack local dev
